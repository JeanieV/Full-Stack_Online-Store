...
import { addToCart, showCart, showModal, generateProductCard, sortProducts, sortProductsHigh, sortProductsLow, filterProducts } from '../js/helper';
...
const fetchData = async () => {
  ...
  try {
    ...
    const product = await Product.fetchAll("ceramic");
    console.log(product);
